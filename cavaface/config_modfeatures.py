...
configurations = {
    1: dict(
        ...
        MODEL_ROOT = '../debug/debug_modfeatures_lowres144+lowres32_with_highres/model', # the root to buffer your checkpoints
        LOG_ROOT = '../debug/debug_modfeatures_lowres144+lowres32_with_highres/logs_modfeatures_lowres144+lowres32_with_highres', # the root to log your train/val status
        ...
        BACKBONE_NAME1 = 'IR_SE_18', # support: ['MobileFaceNet', 'ResNet_50', 'ResNet_101', 'ResNet_152', 
